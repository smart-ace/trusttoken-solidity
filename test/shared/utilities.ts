import { Contract, providers, utils, BigNumber, Bytes } from "ethers";
const {
  AbiCoder,
  defaultAbiCoder,
  getAddress,
...
export function encodeStringToBytes32(value: string) {
  return formatBytes32String(value);
}

export function decodeBytesToString(value: Bytes) {
  return parseBytes32String(value);
}

export function encodeStringToBytes(value: string) {
